<?php include("dbase.php");
	...
	if(!empty($_POST['search'])) { 
		$sql = "SELECT * FROM adlist WHERE id='".$_POST['search']."' AND (roomNo='B1001' OR roomNo='B1002' OR roomNo='B1003' OR roomNo='B1004' OR roomNo='B1005')";
		$query = $conn -> query($sql);
		$row = $query -> fetch_assoc();
	} else {
		$sql = "SELECT * FROM adlist WHERE (roomNo='B1001' OR roomNo='B1002' OR roomNo='B1003' OR roomNo='B1004' OR roomNo='B1005')";
		$query = $conn -> query($sql);
		$row = $query -> fetch_assoc();
	}
?>
<?php include("navbarBlockB.php"); ?>
...
<body>
	<div class="main">
		...
		<div class="container">
				<h2><center><font style="font-family:Trajan Pro;color:teal;"><b>Block B - Booking List</b></font></center></h2>
