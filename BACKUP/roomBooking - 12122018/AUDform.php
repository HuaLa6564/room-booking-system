	  ...
	  height: 1500px; /* Used in this example to enable scrolling */
		...
		<script type="text/javascript">
			function validate(){
				...
				if(aud>241){
					alert("Number of audience must less than 240");
					return false;
				}
				if(tarikh==""){
...
<body>
	<div class="main">
		...
		<h2>Booking Form</h2>
		<table>
			<form name="form1" method="post" action="AUDsave.php"><!--onsubmit="return validate()" -->
				<table border="0" width="" align="center">
					...
					<tr>
						<td></td>
						<td align="center"><font style="color:red" size="1" face="Courier">*Number of audience must less than 240 </font></td>
					</tr>
					<tr>
						<td>Date :</td>
